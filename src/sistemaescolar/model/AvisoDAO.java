...
public class AvisoDAO {
    ...
    public static boolean save(Aviso aviso) throws PersistentException {
        try {
            EscuelaPersistentManager.instance().saveObject(aviso);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            throw new PersistentException(e);
    ...
    public static boolean refresh(Aviso aviso) throws PersistentException {
        try {
            EscuelaPersistentManager.instance().getSession().refresh(aviso);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            throw new PersistentException(e);
    ...
    public static boolean evict(Aviso aviso) throws PersistentException {
        try {
            EscuelaPersistentManager.instance().getSession().evict(aviso);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            throw new PersistentException(e);
