...
public class EventoDAO {
	...
	public static boolean save(Evento evento) throws PersistentException {
		try {
			sistemaescolar.EscuelaPersistentManager.instance().saveObject(evento);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Evento evento) throws PersistentException {
		try {
			sistemaescolar.EscuelaPersistentManager.instance().deleteObject(evento);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(Evento evento) throws PersistentException {
		try {
			sistemaescolar.EscuelaPersistentManager.instance().getSession().refresh(evento);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Evento evento) throws PersistentException {
		try {
			sistemaescolar.EscuelaPersistentManager.instance().getSession().evict(evento);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
