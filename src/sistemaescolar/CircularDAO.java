...
public class CircularDAO {
	...
	public static boolean save(Circular circular) throws PersistentException {
		try {
			sistemaescolar.EscuelaPersistentManager.instance().saveObject(circular);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Circular circular) throws PersistentException {
		try {
			sistemaescolar.EscuelaPersistentManager.instance().deleteObject(circular);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(Circular circular) throws PersistentException {
		try {
			sistemaescolar.EscuelaPersistentManager.instance().getSession().refresh(circular);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Circular circular) throws PersistentException {
		try {
			sistemaescolar.EscuelaPersistentManager.instance().getSession().evict(circular);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
